              ...
              <form action="search-carresult.php" method="post">
                <div class="form-group select">
                  <select class="form-control" name="brand">
                    ...
                    if ($query->rowCount() > 0) {
                      foreach ($results as $result) { ?>
                        <option value="<?php echo htmlentities($result->id); ?>" <?php if (isset($_POST['brand']) && $_POST['brand'] == $result->id) echo 'selected'; ?>><?php echo htmlentities($result->BrandName); ?></option>
                    <?php }
                    } ?>
                  </select>
                </div>
                <div class="form-group select">
                  <select class="form-control" name="fueltype">
                    ...
                    <option value="Petrol" <?php if (isset($_POST['fueltype']) && $_POST['fueltype'] == 'Petrol') echo 'selected'; ?>>Petrol</option>
                    <option value="Diesel" <?php if (isset($_POST['fueltype']) && $_POST['fueltype'] == 'Diesel') echo 'selected'; ?>>Diesel</option>
                    <option value="CNG" <?php if (isset($_POST['fueltype']) && $_POST['fueltype'] == 'CNG') echo 'selected'; ?>>CNG</option>
                  </select>
                </div>

                <div class="form-group">
                  <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Car</button>
                  <a href="car-listing.php" class="btn btn-block"><i class="fa fa-refresh" aria-hidden="true"></i> Reset Search</a>
                </div>
              </form>
            </div>
          </div>
